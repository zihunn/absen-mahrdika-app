...
abstract class $DeviceInfoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? model, String? id, String? version});
}
...
/// @nodoc
@JsonSerializable()
class _$_DeviceInfoModel implements _DeviceInfoModel {
  _$_DeviceInfoModel({this.model, this.id, this.version});
  ...
  @override
  String toString() {
    return 'DeviceInfoModel(model: $model, id: $id, version: $version)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, model, id, version);
...
abstract class _DeviceInfoModel implements DeviceInfoModel {
  factory _DeviceInfoModel(
      {final String? model,
      final String? id,
      final String? version}) = _$_DeviceInfoModel;
